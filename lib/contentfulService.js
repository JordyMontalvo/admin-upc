...
// Obtener eventos futuros (considerando fecha de inicio y fecha de fin)
const getLatestEvents = async () => {
  ...
  try {
    ...
    console.log(`✅ Se encontraron ${validEvents.length} eventos válidos (de ${allEvents.items.length} totales)`);
    return validEvents.map(formatEvent);
